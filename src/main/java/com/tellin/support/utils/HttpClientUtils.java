...
public class HttpClientUtils {
    ...
    /**
     * @ Content-Type : application/json/ Authorization 호출
     */
    public static HttpResponse<String> sendPostAuthorization(String url, String accessToken, Map<String,String> params) throws IOException, InterruptedException {
        String encodedFrom = encodeParams(params);
